...
use BookingsVendor\WPDesk\License\Page\LicensePage;
use BookingsVendor\WPDesk\PluginBuilder\Plugin\Hookable;
use BookingsVendor\WPDesk\License\InstalledPlugins;
/**
 * Integrates WP Desk licenses with WordPress
 *
 * @package WPDesk\Helper
 */
class LicenseIntegration implements \BookingsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \BookingsVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \BookingsVendor\WPDesk\License\Page\LicensePage($plugin_registry);
