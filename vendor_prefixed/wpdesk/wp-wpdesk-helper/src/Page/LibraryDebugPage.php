 ...
 */
class LibraryDebugPage implements \BookingsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function hooks()
    {
        \add_action('admin_menu', function () {
            ...
            \add_submenu_page($parent_slug, \__('Library report', 'inspirelabs-bookings'), \__('Library report', 'inspirelabs-bookings'), 'manage_options', 'wpdesk-helper-library-report', function () {
