...
if (!\interface_exists('BookingsVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('BookingsVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('BookingsVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \BookingsVendor\WPDesk_Translatable, \BookingsVendor\WPDesk_Buildable, \BookingsVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
