 ...
 */
abstract class AbstractPlugin extends \BookingsVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin
{
    /**
    ...
    {
        $support_link = \get_locale() === 'pl_PL' ? 'https://ilabs.dev/contact/' : 'https://ilabs.dev/contact/';
        if ($this->support_url) {
