...
namespace BookingsVendor\WPDesk\PluginBuilder\BuildDirector;

use BookingsVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder;
...
class LegacyBuildDirector
{
    /** @var AbstractBuilder */
    private $builder;
    public function __construct(\BookingsVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder $builder)
    {
