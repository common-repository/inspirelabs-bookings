...
if (!\interface_exists('BookingsVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('BookingsVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \BookingsVendor\WPDesk_Requirement_Checker
    {
