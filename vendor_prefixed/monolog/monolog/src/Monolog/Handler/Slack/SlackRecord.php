 ...
 */
namespace BookingsVendor\Monolog\Handler\Slack;
...
class SlackRecord
{
    ...
    public function __construct($channel = null, $username = null, $useAttachment = \true, $userIcon = null, $useShortAttachment = \false, $includeContextAndExtra = \false, array $excludeFields = array(), \BookingsVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \BookingsVendor\Monolog\Formatter\NormalizerFormatter();
        }
    }
    ...
    {
        switch (\true) {
            case $level >= \BookingsVendor\Monolog\Logger::ERROR:
                return self::COLOR_DANGER;
            case $level >= \BookingsVendor\Monolog\Logger::WARNING:
                return self::COLOR_WARNING;
            case $level >= \BookingsVendor\Monolog\Logger::INFO:
    ...
    public function stringify($fields)
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \BookingsVendor\Monolog\Utils::jsonEncode($normalized, $prettyPrintFlag | $flags) : \BookingsVendor\Monolog\Utils::jsonEncode($normalized, $flags);
    }
    /**
     * Sets the formatter
     *
