 ...
 */
class RotatingFileHandler extends \BookingsVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \BookingsVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \BookingsVendor\Monolog\Utils::canonicalizePath($filename);
