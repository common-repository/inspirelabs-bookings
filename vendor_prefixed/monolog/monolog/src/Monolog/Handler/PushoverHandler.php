 ...
 */
class PushoverHandler extends \BookingsVendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \BookingsVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \BookingsVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \BookingsVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \BookingsVendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \BookingsVendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
