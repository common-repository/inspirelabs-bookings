 ...
 */
abstract class AbstractHandler implements \BookingsVendor\Monolog\Handler\HandlerInterface, \BookingsVendor\Monolog\ResettableInterface
{
    protected $level = \BookingsVendor\Monolog\Logger::DEBUG;
