 ...
 */
class SocketHandler extends \BookingsVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($connectionString, $level = \BookingsVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
