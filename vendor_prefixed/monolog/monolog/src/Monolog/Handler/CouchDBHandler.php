 ...
 */
class CouchDBHandler extends \BookingsVendor\Monolog\Handler\AbstractProcessingHandler
{
    private $options;
    public function __construct(array $options = array(), $level = \BookingsVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
