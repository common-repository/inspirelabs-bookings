 ...
 */
class BrowserConsoleHandler extends \BookingsVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \BookingsVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
