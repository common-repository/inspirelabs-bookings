 ...
 */
class SlackbotHandler extends \BookingsVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \BookingsVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
